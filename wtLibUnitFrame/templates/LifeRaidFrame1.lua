...
LifeRaidFrame1.Configuration.UnitSuitable = false
LifeRaidFrame1.Configuration.FrameType = "Frame"
LifeRaidFrame1.Configuration.Width = 50
LifeRaidFrame1.Configuration.Height = 20
LifeRaidFrame1.Configuration.Resizable = { 55, 40, 500, 70 }
...
function LifeRaidFrame1:Construct(options)
	...
	self:EventAttach(
		...
		function(el)
			...
			local fracHeight = newHeight / LifeRaidFrame1.Configuration.Height
