...
function StandardFrame:Construct(options)
	...
	local elements = 
	{
		...
		
		{
			...
			text="{nameShort}", default="", fontSize=14,font="Montserrat-Bold", outline=true
		},
		{
			...
			text=" {resource}/{resourceMax}", default="", fontSize=10,font="Montserrat-Bold"
		},
		{
			...
			visibilityBinding="resource",
			text="{resourcePercent}%", default="", fontSize=10,font="Montserrat-Bold"
		},
		{
			...
			text="{level} {callingText}", default="", fontSize=10,font="Montserrat-Bold", outline=true
		},
		{
		...
		},
		{
			...
			visibilityBinding="castName",
			text="{castName}", default="", fontSize=11,font="Montserrat-Bold"
		},
