...
local function Create(configuration)
	...
	local top = UI.CreateFrame("Frame", "TopBorder", chargeMeter)
	...
	local bottom = UI.CreateFrame("Frame", "BottomBorder", chargeMeter)
	...
	local left = UI.CreateFrame("Frame", "LeftBorder", chargeMeter)
	...
	local right = UI.CreateFrame("Frame", "RightBorder", chargeMeter)
...
WT.Gadget.RegisterFactory("ChargeMeter",
	{
		...
		iconTexFile="img/menuIcons/wtCharge.png",
		["Create"] = Create,
