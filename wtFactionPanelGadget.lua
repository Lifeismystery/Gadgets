...
local function UpdatePanel(panel, showAll)
	...
	for factionId, detail in pairs(details) do
		...
		if not catText.Factions[detail.name] then
			...
			local top = UI.CreateFrame("Frame", "TopBorder", factionFrame)
			...
			local bottom = UI.CreateFrame("Frame", "BottomBorder", factionFrame)
			...
			local left = UI.CreateFrame("Frame", "LeftBorder", factionFrame)
			...
			local right = UI.CreateFrame("Frame", "RightBorder", factionFrame)
