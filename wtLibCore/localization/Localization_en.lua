...
Library.Translate.En(
{
	...
	gadgetDataTextBar_name = "DataTextBar", 
	gadgetDataTextBar_desc = "Displays DataTextBar",
	gadgetBossAlert_name = "Data Text Bar", 
	gadgetBossAlert_desc = "Displays Data Text Bar",	
